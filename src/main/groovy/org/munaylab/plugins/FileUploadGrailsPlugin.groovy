...
class FileUploadGrailsPlugin extends Plugin {
    ...
    def title = "File Upload Plugin" // Headline display name of the plugin
    def author = "Munaylab Team"
    def authorEmail = "team@munaylab.org"
    def description = '''\
File Upload Plugin for Munaylab
'''
    def profiles = ['web']

    // URL to the plugin's documentation
    def documentation = "http://grails.org/plugin/org-munaylab-plugins-fileupload"
